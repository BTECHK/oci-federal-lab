...
| **AI** | Ollama (FedRAMP readiness agent, on-prem / air-gap capable) · **v3:** air-gapped BM25 RAG + compliance Q&A chatbot, LLM evidence classification + POA&M drafting, container-layer pull-through cache — see ADRs 021-023 |
