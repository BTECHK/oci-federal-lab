...
| Pillar | Promised Deliverable | Status | Guide Section | Verified |
|--------|---------------------|--------|---------------|----------|
| API | API key auth + validation endpoint | DONE | Phase 25 (FedCompliance app) | 2026-04-08 |
...
| AI | scikit-learn IsolationForest anomaly detection | DONE | Phase 25 (Step 25.4) | 2026-04-08 |
| Security | Trivy + SBOM supply chain security | DONE | Phase 23 (Steps 23.2-23.5) | 2026-04-08 |
| Container | Helm + ArgoCD GitOps | DONE | Phase 24 (full day) | 2026-04-08 |
| Load Balancing | OCI LB Terraform (3-tier as code) | DONE | Appendix E | 2026-04-08 |
| IaC/Terraform | Modules (network, compute, database) | DONE | Phase 22 (Steps 22.2-22.8) | 2026-04-08 |
| Ansible | Vault integration + secrets from OCI Vault | DONE | Phase 22 (Steps 22.9-22.11) | 2026-04-08 |
| CI/CD | 9-stage Jenkins pipeline with security gates | DONE | Phase 23 (Steps 23.6-23.10) | 2026-04-08 |
| Compliance | compliance_collector.py — OCI API queries to CMMC mapping | DONE | Phase 25 | 2026-04-08 |
| OCI Vault | Secrets management with instance principals | DONE | Phase 22 (Step 22.9) | 2026-04-08 |
| Break-fix | Hands-on exercises (CrashLoopBackOff, pipeline gate, Helm rollback, ArgoCD drift) | DONE | Phase 25B (Exercises 1-4) | 2026-04-08 |
